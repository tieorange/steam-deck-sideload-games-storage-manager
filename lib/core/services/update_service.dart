  ...
  Future<UpdateStatus> checkForUpdate() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _logger.info(
          'Latest version: $latestVersion, Current: $currentVersion, Newer: $isNewer',
          tag: 'Update',
        );
...
class UpdateStatus {
  ...
  factory UpdateStatus.noUpdate(String version) =>
      UpdateStatus(currentVersion: version, latestVersion: version, isUpdateAvailable: false);
