...
class PlatformService {
  ...
  String get heroicFlatpakPath => 
    '$homeDir/.var/app/com.heroicgameslauncher.hgl/config';
  ...
  String? get heroicConfigPath {
    if (Directory('$heroicFlatpakPath/heroic').existsSync()) {
      return '$heroicFlatpakPath/heroic';
    }
    if (Directory(heroicStandardPath).existsSync()) {
  ...
  String? get legendaryInstalledJsonPath {
    ...
    // Flatpak path structure is different
    if (heroicPath.contains('.var/app')) {
      return '$homeDir/.var/app/com.heroicgameslauncher.hgl/config/legendary/installed.json';
    }
    return '$homeDir/.config/legendary/installed.json';
  }
  ...
  String get ogiLibraryPath => 
    '$homeDir/.local/share/OpenGameInstaller/library';
  ...
  String get lutrisFlatpakDbPath => 
    '$homeDir/.var/app/net.lutris.Lutris/data/lutris/pga.db';
  
  String get lutrisStandardDbPath => 
    '$homeDir/.local/share/lutris/pga.db';
  ...
  bool get isSteamDeck {
    ...
    return homeDir.endsWith('/deck') || 
           Platform.environment['SteamDeck'] == '1';
  }
